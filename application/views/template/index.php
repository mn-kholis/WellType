                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                      <!-- <img src="<?php echo base_url() ?>template/production/images//img.jpg" alt=""> -->
                      Tia
                    </a>
                        ...
                        <ul class="list-unstyled top_profiles scroll-view">
                          <li class="media event">
                            ...
                            <div class="media-body">
                              <a class="title" href="#">Ervin Reka</a>
                              <p> ervinreka@gmail.com</p>
                              <p> <small>Top 1</small>
                              </p>
                            </div>
                          </li>
                          <li class="media event">
                            ...
                            <div class="media-body">
                              <a class="title" href="#">Tia Puspita sari</a>
                              <p>tiapuspita@gmail.com</p>
                              <p> <small>Top 2</small>
                              </p>
                            </div>
                          </li>
                          <li class="media event">
                            ...
                            <div class="media-body">
                              <a class="title" href="#"> Muhammad Nurkholis</a>
                              <p>kholis@gmail.com</p>
                              <p> <small>Top 3</small>
                              </p>
                            </div>
                          </li>
                          <li class="media event">
                            ...
                            <div class="media-body">
                              <a class="title" href="#">Renita Tri Hastuti</a>
                              <p> renita@gmail.com</p>
                              <p> <small>Top 4</small>
                              </p>
                            </div>
                          </li>
                          <li class="media event">
                            ...
                            <div class="media-body">
                              <a class="title" href="#">Fadhila Asla Shana</a>
                              <p>fadhila@gmail.com</p>
                              <p> <small>top 5</small>
                              </p>
                            </div>
                          </li>
