...
function newGame() {
  ...
  document.getElementById('info').innerHTML = (gameTime / 1000) + ' Timer';
  window.timer = null;
}
...
document.getElementById('game').addEventListener('keyup', ev => {
  ...
  if (!window.timer && isLetter) {
    window.timer = setInterval(() => {
      ...
      document.getElementById('info').innerHTML = sLeft + ' Timer';
    }, 1000);
  }
...
document.getElementById('backBtn').addEventListener('click', () => {
  window.location.href = "http://localhost/WellType/WellType/";
});
